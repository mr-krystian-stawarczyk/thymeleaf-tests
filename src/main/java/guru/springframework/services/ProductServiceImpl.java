...
public class ProductServiceImpl implements ProductService {
  ...
  private void loadProducts() {
    ...
    thymeleaf.setPrice(new BigDecimal("69"));
    ...
    springCore.setPrice(new BigDecimal("18"));
    ...
    springCoreAdv.setPrice(new BigDecimal("29"));
    ...
    springCoreDevOps.setCourseSubtitle(
    ...
    springCoreDevOps.setPrice(new BigDecimal("99"));
